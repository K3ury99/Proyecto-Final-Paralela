...
public class IBKRClient : EWrapper
{
    ...
    // Implementa solo lo esencial para este demo
    public void nextValidId(int orderId) => Console.WriteLine($"Next Order ID: {orderId}");
    ...
    public void connectionClosed() => Console.WriteLine("Conexión cerrada");
    ...
    // ... Otros métodos de EWrapper (puedes dejarlos vacíos si no se usan)
}
